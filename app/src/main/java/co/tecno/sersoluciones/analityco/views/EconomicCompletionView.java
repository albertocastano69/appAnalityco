 ...
 **/
public class EconomicCompletionView extends TokenCompleteTextView<EconomicActivity> {

    public EconomicCompletionView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    @Override
    protected View getViewForObject(EconomicActivity item) {
        ...
        token.setText(item.Code);
        return token;
        //return view;
    }

    @Override
    protected EconomicActivity defaultObject(String completionText) {
        ...
        return new EconomicActivity(completionText, completionText);
    }
