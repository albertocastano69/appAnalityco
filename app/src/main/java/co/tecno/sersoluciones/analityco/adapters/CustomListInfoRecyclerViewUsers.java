...
public abstract class CustomListInfoRecyclerViewUsers<T> extends RecyclerView.Adapter<CustomListInfoRecyclerViewUsers.ViewHolder> {

    protected final ArrayList<T> mItems;
    public final Context mContext;

    protected CustomListInfoRecyclerViewUsers(Context context, ArrayList<T> mItems) {
        this.mItems = mItems;
