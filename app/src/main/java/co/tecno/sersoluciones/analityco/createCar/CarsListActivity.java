...
import co.tecno.sersoluciones.analityco.individualContract.CreateIndividualContractActivity;
...
public class CarsListActivity extends BaseActivity implements TextWatcherAdapter.TextWatcherListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mSectionsPagerAdapter.addFrag(CarListFragment.newInstance(1));
        mSectionsPagerAdapter.addFrag(CarListFragment.newInstance(2));
        mSectionsPagerAdapter.addFrag(CarListFragment.newInstance(3));
        mSectionsPagerAdapter.addFrag(CarListFragment.newInstance(4));
        ...
        View headerView = ((LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE))
                .inflate(R.layout.custom_tab_car, null, false);
        ...
        fab.setOnClickListener(v -> {
            Intent intent = new Intent(CarsListActivity.this, CreateIndividualContractActivity.class);
