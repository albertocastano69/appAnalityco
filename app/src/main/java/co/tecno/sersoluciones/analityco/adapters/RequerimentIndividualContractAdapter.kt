...
class RequerimentIndividualContractAdapter(
        private val mContext: Context,
        private val mValues: List<RequerimentIndividualContract>,
        private val mListener: OnDocumentIndivudualContractListenerEdit?,
        private val showPencil : Boolean?
): RecyclerView.Adapter<RequerimentIndividualContractAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.btnEdit.setOnClickListener { mListener?.editRequerimentItemUpload(holder.mItem,position) }
    ...
    interface OnDocumentIndivudualContractListenerEdit {
        fun editRequerimentItemUpload(mItem: RequerimentIndividualContract?, pos: Int)
    }
}