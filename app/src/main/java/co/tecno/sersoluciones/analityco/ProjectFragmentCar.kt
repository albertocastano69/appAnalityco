...
import co.tecno.sersoluciones.analityco.ui.createPersonal.ProjectFragmentDirections
...
class ProjectFragmentCar : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val adapter = DataItemListAdapter(DataItemListAdapter.OnClickListener {
            ...
            DebugLog.logW("project ${selectedProject.Name}")
        ...
        viewModel.navigateToSelectTypeContractFragment.observe(viewLifecycleOwner, Observer {
            it?.let {
                findNavController()
                        .navigate(
                                ProjectFragmentCarDirections.actionProjectFragmentToContractTypeFragment2(viewModel.selectedProject.value!!)
                        )
    ...
    override fun onStart() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M &&
            ...
            (activity as CreateCarActivity).startLocationService()
        }
    }
    ...
    override fun onStop() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M &&
            ...
            (activity as CreateCarActivity).stopLocationService()
        }
    }
